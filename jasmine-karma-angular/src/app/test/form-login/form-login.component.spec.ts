...
describe('Testando o FormLoginComponent', () => {
  ...
  it('Deve instanciar o FormLoginComponent', () => {
  ...
  it('Deve retornar que formulario é valido', () => {
    component.form.controls['email'].setValue('Fulanodev.silva@gmail.com')
  ...
  it('Deve estar habiltar o botão quando formulario for valido', () => {
    component.form.controls['email'].setValue('fulano@gmail.com')
  ...
  it('Deve retornar o valor de um controle de formulario', () => {
    component.form = new FormGroup({
      email: new FormControl('Fulanodev.silva@gmail.com'),
      password: new FormControl('091011'),
    })

    expect(component.getValueControl(component.form, 'email')).toEqual('Fulanodev.silva@gmail.com')
  })
  ...
  it('Deve criar payload para submeter para api', () => {
    ...
    expect(component.createPayload('fulano@gmail.com', '091011')).toEqual(payload)
  })

  it("Deve realizar login", () => {
    component.form = new FormGroup({
      email: new FormControl('Fulano'),
      password: new FormControl('091011'),
    })
    let response = {
      "email": "Fulanodev.silva@gmail.com",
      "password": "09101",
      "id": 1
    }
