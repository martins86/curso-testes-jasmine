...
describe('Testando o MatchersJasmineComponent', () => {
  ...
  it('Deve instanciar o MatchersJasmineComponent', () => {
  ...
  it('Deve testar o uso do matcher toBe', () => {
    let nomes = ['Fulano', 'Carlos', 'Jose']
    let nomes2 = ['Fulano', 'Carlos', 'Jose']
  ...
  it('Deve testar o uso do matcher not', () => {
    expect('Fulano').not.toEqual('Felicia')
  })
